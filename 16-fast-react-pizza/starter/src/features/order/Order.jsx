...
function Order() {
  ...
  const fetcher = useFetcher(); // react-router access fetcher is useed to get data from a route without specifically going to the route where the data is coming from
